...
cd ../../../..
cd frameworks/av
git apply -v --check ../../device/archos/persimmon/patches/framework_av/0001-mtk6735.patch
...
cd ../..
cd frameworks/base
git apply -v --check ../../device/archos/persimmon/patches/framework_base/0001-mtk6735.patch
cd ../..
cd packages/apps/Settings/
git apply -v --check ../../../device/archos/persimmon/patches/packages_apps_Settings/0001-mtk6735.patch
cd ../../..
cd frameworks/opt/telephony
git apply -v --check ../../../device/archos/persimmon/patches/framework_opt_telephony/0001-mtk6735.patch
cd ../../..
